...
import { loadDataIntoMoveEventToNewLocationForm } from "~/app/_components/forms/load-data-into-form";
    ...
    <BaseModal title="Move Event to New Location">
      <Form {...form}>
        ...
        >
          ...
          <RequestFormSelector requestType="move_event_to_new_location" />
          <ContactDetailsForm />
