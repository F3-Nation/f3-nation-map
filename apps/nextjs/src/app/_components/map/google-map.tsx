...
export const GoogleMapComponent = () => {
  ...
  useEffect(() => {
    queryParamStore.setState({
      lat: queryLat,
      lon: queryLon,
      zoom: queryZoom,
      locationId: queryLocationId ? Number(queryLocationId) : null,
      eventId: queryEventId ? Number(queryEventId) : null,
    });
  }, [queryLat, queryLon, queryZoom, queryLocationId, queryEventId]);
...
const getDefaultCenter = () => {
  const queryLat = queryParamStore.get("lat");
  const queryLon = queryParamStore.get("lon");
  const center = mapStore.get("center");
  return queryLat != null && queryLon != null
...
const getDefaultZoom = () => {
  const queryZoom = queryParamStore.get("zoom");
