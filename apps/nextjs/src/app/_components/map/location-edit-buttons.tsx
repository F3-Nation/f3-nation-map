...
export const LocationEditButtons = ({
  ...
  console.log("location edit buttons", locationId, eventId, aoId);
  return (
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-56 max-w-[calc(100vw-2rem)]">
          ...
          <DropdownMenuItem
            ...
            onClick={() => {
              openRequestModal({ type: "delete_ao", locationId, aoId });
            }}
          >
            <span className="inline-flex items-center">
          ...
          <DropdownMenuContent className="w-56 max-w-[calc(100vw-2rem)]">
            <DropdownMenuItem
              ...
              onClick={() => {
                ...
                openRequestModal({ type: "edit_event", eventId, locationId });
              }}
            >
              <span className="inline-flex items-center">
                <Edit className="mr-2 h-4 w-4 flex-shrink-0" />
