...
CREATE TYPE "public"."request_type" AS ENUM('create_location_and_event', 'create_event', 'edit-event', 'edit-ao-and-location', 'move_ao_to_different_region', 'move_ao_to_new_location', 'move_ao_to_different_location', 'move_event_to_different_ao', 'move_event_to_new_location', 'delete_event', 'delete_ao', 'edit');--> statement-breakpoint
